...
def not_bad(s):
    ...
    return f'{s.replace(s[n:b+3], "good") if n < b else s}'
...
if __name__ == '__main__':
    ...
    test(not_bad, 'This movie is not not so bad', 'This movie is good')
    test(not_bad, 'This movie is bad not so bad', 'This movie bad is good')
